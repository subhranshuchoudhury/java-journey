...
public class Main
{
  public static void main (String[]args)
  {
    Scanner scan = new Scanner (System.in);
      System.out.println
      ("[RULE]:\n[*] Your Guess number's sum must higher than computer's sum.\n[*] Difference between sum must less than 3.\n\n");
    ...
    int computerSum = roll1 + roll2 + roll3;
      ...
      System.out.println ("Computer's entries: " + roll1 + " " + roll2 + " " +
			  roll3);
    ...
    if (humanSum > computerSum && humanSum - computerSum < 3)
      {
